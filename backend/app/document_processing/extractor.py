...
def _ocr_image_bytes(image_bytes: bytes) -> str:
    """OCR an image using optional EasyOCR with preprocessing. Returns '' if unavailable."""
    try:
        import easyocr
        import numpy as np
        from PIL import Image

        # Apply EXIF transpose, contrast and sharpness enhancement
        ...
        logger.warning("EasyOCR unavailable or failed: %s", exc)
        return ""
